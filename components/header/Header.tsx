  ...
  return (
    <header className="flex flex-col items-center justify-center border-t-4 border-t-violet-700">
      <div className="w-full flex items-center justify-center bg-background">
        <div className="max-w-5xl px-2 xl:px-0 h-16 w-full flex items-center gap-2 justify-between">
          <div className="flex items-center gap-2 flex-1">
            <SidebarTrigger className="text-violet-700 size-9 hover:cursor-pointer rounded hover:text-violet-500" />
            <h1
              className={cn(
